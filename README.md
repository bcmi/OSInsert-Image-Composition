...
OSInsert can achieve both high-fidelity (keep the appearance details of reference image) and high-authenticity (adjust foreground pose/viewpoint according to the background). 

![](figures/pipeline.jpg) 

## Online Demo

OSInsert has been integrated into the image composition toolbox [libcom](https://github.com/bcmi/libcom). Try this [online demo](http://libcom.ustcnewly.com/) for image composition (object insertion) built upon [libcom](https://github.com/bcmi/libcom) toolbox and have fun!
